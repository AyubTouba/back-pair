...
use commands::backup_command::{run_backup,history_backup};
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![add_profile, list_profiles,delete_profile,edit_profile,run_backup,history_backup])
